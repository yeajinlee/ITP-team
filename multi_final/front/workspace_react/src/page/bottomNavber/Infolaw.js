...
const infolaw = () => {
    return (
    <div class="infolawpage">
    <div>
      <h3>개인정보처리방침</h3>
    </div>
    <div class="lawcontent">
      <p>(주)멀티캠퍼스는 (이하 "회사"는) 고객님의 개인정보를 중요시하며, "개인정보 보호법" 등 관련 법령을 준수하고 있습니다.
